...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Internet of Things (IOT) Powered Automated Delivery Vehicle with Robotic Arm for Smart Warehousing}
\subCode{XX367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Pranav Darshan}
\stuUSNA{1RV22CS143}
\stuNameB{Raghuveer Narayanan Rajesh}
\stuUSNB{1RV22CS154}
\stuNameC{Namith Shivananda Gowda}
\stuUSNC{1RV22EC099}
\stuNameD{Asish Pavanram Gandrothu}
\stuUSND{1RV22ET009}
\stuNameE{Amish Srivastava}
\stuUSNE{1RV22ME018}
\stuNameF{Ashwin Kadloor}
\stuUSNF{1RV22ME032}
...
\guideNameA{Dr. Nanjundaradhya N V}
\guideDesignationA{Professor}
\guideDeptA[Mechanical Engineering]{Mechanical Engineering}
\guideOrgA{RV College of Engineering}

%% External Guide %%
%\guideNameB{Dr. External Guide Name}
%\guideDesignationB{Assistant Professor}
%\guideDeptB{Dept. of ECE}
%\guideOrgB{External Organization}

%\guideNameC{Dr. Third Guide Name}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  QRL %%%%%%%%%%%%%%%%%%%%%%%%%%
\QRurl{https://drive.google.com/drive/folders/1gzTfygrdORR3v2IP0EsQs6K8j79PxaHH?usp=sharing}
...
% If backend is bibtex, then configure texmaker Bi(La)Tex with "bibtex %"
